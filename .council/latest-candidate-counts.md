...
# Generated: 2026-07-08T16:29:07Z
...
internal/plexlabelproxy/proxy_test.go:1344:		OwnerToken:    "owner-token",
internal/plexlabelproxy/proxy_test.go:1345:		ElevateLiveTV: true,
internal/plexlabelproxy/proxy_test.go:1352:	req := httptest.NewRequest(http.MethodPost, "/media/subscriptions?X-Plex-Token=user-token", strings.NewReader("guid=com.plexapp.agents.imdb%3A%2F%2Ftt1234567"))
internal/plexlabelproxy/proxy_test.go:1390:	req := httptest.NewRequest(http.MethodGet, "/livetv/dvrs?X-Plex-Token=user-token", nil)
internal/plexlabelproxy/proxy_test.go:1394:	if got := req.URL.Query().Get("X-Plex-Token"); got != "owner-token" {
internal/plexlabelproxy/proxy_test.go:1397:	if got := req.Header.Get("X-Plex-Token"); got != "owner-token" {
internal/plexlabelproxy/proxy_test.go:1401:	library := httptest.NewRequest(http.MethodGet, "/library/sections?X-Plex-Token=user-token", nil)
internal/plexlabelproxy/proxy_test.go:1405:	if got := library.URL.Query().Get("X-Plex-Token"); got != "user-token" {
internal/plexlabelproxy/proxy_test.go:1410:	bait := httptest.NewRequest(http.MethodGet, "/library/sections?X-Plex-Token=user-token&bait=%2Flivetv%2Fdvr", nil)
internal/plexlabelproxy/proxy_test.go:1414:	if got := bait.URL.Query().Get("X-Plex-Token"); got != "user-token" {
internal/plexlabelproxy/proxy_test.go:1422:		gotToken = r.URL.Query().Get("X-Plex-Token")
internal/plexlabelproxy/proxy_test.go:1429:	proxy, err := New(Config{Upstream: up.URL, Token: "label-token", OwnerToken: "owner-token", ElevateLiveTV: true, UserHeader: true})
internal/plexlabelproxy/proxy_test.go:1435:	req := httptest.NewRequest(http.MethodGet, "/livetv/dvrs?X-Plex-Token=user-token", nil)
internal/plexlabelproxy/proxy_test.go:1455:	proxy, err := New(Config{Upstream: up.URL, Token: "label-token", OwnerToken: "owner-token", ElevateLiveTV: true, UserHeader: true})
internal/plexlabelproxy/proxy_test.go:1461:	req := httptest.NewRequest(http.MethodGet, "/library/sections?X-Plex-Token=user-token", nil)
internal/plexlabelproxy/proxy_test.go:1476:		requests = append(requests, seen{r.URL.Path, r.URL.Query().Get("X-Plex-Token")})
internal/plexlabelproxy/proxy_test.go:1482:	proxy, err := New(Config{Upstream: up.URL, Token: "label-token", OwnerToken: "owner-token", ElevateLiveTV: true, ElevateDiscoveryOnly: true})
internal/plexlabelproxy/proxy_test.go:1488:		"/livetv/dvrs?X-Plex-Token=user-token",
internal/plexlabelproxy/proxy_test.go:1489:		"/media/providers?X-Plex-Token=user-token",
internal/plexlabelproxy/proxy_test.go:1490:		"/video/:/transcode/universal/start.m3u8?X-Plex-Token=user-token&path=%2Flivetv%2Fsessions%2Fabc%2Findex.m3u8",
internal/plexlabelproxy/proxy_test.go:1491:		"/playQueues?X-Plex-Token=user-token&uri=%2Flivetv%2Fsessions%2Fabc%2Findex.m3u8",
internal/plexlabelproxy/proxy_test.go:1571:		OwnerToken:             "owner-token",
internal/plexlabelproxy/proxy_test.go:1572:		ElevateLiveTV:          true,
internal/plexlabelproxy/proxy_test.go:1583:		"/video/:/transcode/universal/start.m3u8?X-Plex-Token=user-token&path=%2Flivetv%2Fsessions%2Fabc%2Findex.m3u8",
internal/plexlabelproxy/proxy_test.go:1591:		"/:/scrobble?X-Plex-Token=user-token&ratingKey=9876&identifier=com.plexapp.plugins.library",
internal/plexlabelproxy/proxy_test.go:1617:		tokens = append(tokens, r.URL.Query().Get("X-Plex-Token"))
internal/plexlabelproxy/proxy_test.go:1627:		OwnerToken:             "owner-token",
internal/plexlabelproxy/proxy_test.go:1628:		ElevateLiveTV:          true,
internal/plexlabelproxy/proxy_test.go:1637:		"/video/:/transcode/universal/start.m3u8?X-Plex-Token=user-token&path=%2Flivetv%2Fsessions%2Fabc%2Findex.m3u8",
internal/plexlabelproxy/proxy_test.go:1648:		"/:/scrobble?X-Plex-Token=user-token&ratingKey=2468&identifier=com.plexapp.plugins.library",
internal/plexlabelproxy/proxy_test.go:1682:		tokens = append(tokens, r.URL.Query().Get("X-Plex-Token"))
internal/plexlabelproxy/proxy_test.go:1684:		if r.URL.Path == "/:/timeline" && r.URL.Query().Get("X-Plex-Token") != "owner-token" {
internal/plexlabelproxy/proxy_test.go:1696:		OwnerToken:             "owner-token",
internal/plexlabelproxy/proxy_test.go:1697:		ElevateLiveTV:          true,
...
internal/plexlabelproxy/proxy_test.go:1712:		"/:/timeline?X-Plex-Token=user-token&state=playing&ratingKey=2468",
internal/plexlabelproxy/proxy_test.go:1750:		tokens = append(tokens, r.URL.Query().Get("X-Plex-Token"))
internal/plexlabelproxy/proxy_test.go:1761:		OwnerToken:             "owner-token",
internal/plexlabelproxy/proxy_test.go:1762:		ElevateLiveTV:          true,
internal/plexlabelproxy/proxy_test.go:1772:		"/video/:/transcode/universal/start.m3u8?X-Plex-Token=user-token&path=%2Flivetv%2Fsessions%2Fabc%2Findex.m3u8",
internal/plexlabelproxy/proxy_test.go:1775:	streamReq.Header.Set("CF-Connecting-IP", "203.0.113.20")
internal/plexlabelproxy/proxy_test.go:1785:		"/:/scrobble?X-Plex-Token=user-token&ratingKey=2468&identifier=com.plexapp.plugins.library",
internal/plexlabelproxy/proxy_test.go:1788:	scrobbleReq.Header.Set("CF-Connecting-IP", "203.0.113.21")
internal/plexlabelproxy/proxy_test.go:1834:		OwnerToken:             "owner-token",
internal/plexlabelproxy/proxy_test.go:1835:		ElevateLiveTV:          true,
internal/plexlabelproxy/proxy_test.go:1844:		"/video/:/transcode/universal/start.m3u8?X-Plex-Token=user-token&path=%2Flivetv%2Fsessions%2Fabc%2Findex.m3u8&playQueueID=777",
internal/plexlabelproxy/proxy_test.go:1849:		"/:/scrobble?X-Plex-Token=user-token&ratingKey=1357&identifier=com.plexapp.plugins.library&playQueueID=777",
internal/plexlabelproxy/proxy_test.go:1893:func TestProxy_ElevateAll_InjectsOwnerTokenOnEveryRequest(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1896:		gotToken = r.URL.Query().Get("X-Plex-Token")
internal/plexlabelproxy/proxy_test.go:1905:		OwnerToken:      "owner-token",
internal/plexlabelproxy/proxy_test.go:1921:		req := httptest.NewRequest(http.MethodGet, path+"?X-Plex-Token=user-token", nil)
internal/plexlabelproxy/proxy_test.go:1932:		gotToken = r.URL.Query().Get("X-Plex-Token")
internal/plexlabelproxy/proxy_test.go:1941:		OwnerToken:      "owner-token",
internal/plexlabelproxy/proxy_test.go:1972:		OwnerToken:             "owner-token",
internal/plexlabelproxy/proxy_test.go:1984:		"/video/:/transcode/universal/start.m3u8?X-Plex-Token=owner-token&path=%2Flivetv%2Fsessions%2Fabc%2Findex.m3u8",
internal/plexlabelproxy/proxy_test.go:1990:		"/:/scrobble?X-Plex-Token=owner-token&ratingKey=42&identifier=com.plexapp.plugins.library",
internal/plexlabelproxy/proxy_test.go:2012:		tokens = append(tokens, r.URL.Query().Get("X-Plex-Token"))
internal/plexlabelproxy/proxy_test.go:2022:		OwnerToken:             "owner-token",
internal/plexlabelproxy/proxy_test.go:2033:		"/video/:/transcode/universal/start.m3u8?X-Plex-Token=user-token&path=%2Flivetv%2Fsessions%2Fabc%2Findex.m3u8",
internal/plexlabelproxy/proxy_test.go:2044:		"/:/scrobble?X-Plex-Token=user-token&ratingKey=99&identifier=com.plexapp.plugins.library",
internal/plexlabelproxy/proxy_test.go:2084:		tokens = append(tokens, r.URL.Query().Get("X-Plex-Token"))
...
internal/plexlabelproxy/proxy_test.go:1320:			if got := IsLiveTVRequest(req); got != tc.want {
internal/plexlabelproxy/proxy_test.go:1321:				t.Fatalf("IsLiveTVRequest() = %v, want %v", got, tc.want)
internal/plexlabelproxy/proxy_test.go:1368:func TestIsLiveTVRequest_MediaSubscriptionLibraryItemNotElevated(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1370:	if IsLiveTVRequest(req) {
internal/plexlabelproxy/proxy_test.go:1377:	if IsLiveTVRequest(post) {
internal/plexlabelproxy/proxy_test.go:1382:func TestIsLiveTVRequest_OptionsPreflightNotElevated(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1384:	if IsLiveTVRequest(req) {
internal/plexlabelproxy/proxy_test.go:1389:func TestApplyLiveTVTokenElevation(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1391:	if !ApplyLiveTVTokenElevation(req, "owner-token") {
internal/plexlabelproxy/proxy_test.go:1402:	if ApplyLiveTVTokenElevation(library, "owner-token") {
internal/plexlabelproxy/proxy_test.go:1411:	if ApplyLiveTVTokenElevation(bait, "owner-token") {
internal/plexlabelproxy/proxy_test.go:1516:func TestIsLiveTVDiscoveryRequest(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1530:		if got := IsLiveTVDiscoveryRequest(req); got != want {
internal/plexlabelproxy/proxy_test.go:1531:			t.Errorf("IsLiveTVDiscoveryRequest(%q) = %v, want %v", target, got, want)
internal/plexlabelproxy/proxy_test.go:1536:func TestIsLiveTVStreamRequest(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1547:		if got := IsLiveTVStreamRequest(req); got != want {
internal/plexlabelproxy/proxy_test.go:1548:			t.Errorf("IsLiveTVStreamRequest(%q) = %v, want %v", target, got, want)
...
internal/plexlabelproxy/entitlement.go:405:// RewriteTunerEntitlementFlags rewrites the small XML/JSON hints Plex Web uses to
internal/plexlabelproxy/entitlement.go:407:// narrow: it only changes allowTuners fields and never rewrites account,
internal/plexlabelproxy/entitlement.go:409:func RewriteTunerEntitlementFlags(body []byte) []byte {
internal/plexlabelproxy/entitlement.go:410:	if len(body) == 0 || !bytes.Contains(body, []byte("allowTuners")) {
internal/plexlabelproxy/entitlement.go:413:	out := bytes.ReplaceAll(body, []byte(`allowTuners="0"`), []byte(`allowTuners="1"`))
internal/plexlabelproxy/entitlement.go:414:	out = bytes.ReplaceAll(out, []byte(`<Setting id="allowTuners" value="0"`), []byte(`<Setting id="allowTuners" value="1"`))
internal/plexlabelproxy/entitlement.go:415:	out = bytes.ReplaceAll(out, []byte(`"allowTuners":false`), []byte(`"allowTuners":true`))
internal/plexlabelproxy/entitlement.go:416:	out = bytes.ReplaceAll(out, []byte(`"allowTuners": false`), []byte(`"allowTuners": true`))
internal/plexlabelproxy/entitlement.go:417:	out = bytes.ReplaceAll(out, []byte(`"allowTuners":0`), []byte(`"allowTuners":1`))
internal/plexlabelproxy/entitlement.go:418:	out = bytes.ReplaceAll(out, []byte(`"allowTuners": 0`), []byte(`"allowTuners": 1`))
...
internal/plexlabelproxy/proxy_test.go:1573:		NeutralizeOwnerHistory: true,
internal/plexlabelproxy/proxy_test.go:1609:func TestProxy_NeutralizeOwnerHistory_CorrelatesByClientIdentifier(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1629:		NeutralizeOwnerHistory: true,
internal/plexlabelproxy/proxy_test.go:1674:func TestProxy_NeutralizeOwnerHistory_ElevatesTrackedTimelineResponse(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1698:		NeutralizeOwnerHistory: true,
internal/plexlabelproxy/proxy_test.go:1742:func TestProxy_NeutralizeOwnerHistory_DoesNotCorrelateDifferentSource(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1763:		NeutralizeOwnerHistory: true,
internal/plexlabelproxy/proxy_test.go:1816:func TestProxy_NeutralizeOwnerHistory_CorrelatesByPlayQueue(t *testing.T) {
internal/plexlabelproxy/proxy_test.go:1836:		NeutralizeOwnerHistory: true,
